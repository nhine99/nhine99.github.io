...
// Thực hiện công việc lúc 5:00 trong 30 ngày vào các ngày lẻ
for (let day = 1; day <= 30; day++) {
    console.log(` Ngày ${day} thức dậy lúc 5:00`);
}
...
// continue : Thực hiện công việc thức dậy lúc 5:00 trong 30 ngày, nhưng vào những ngày cuối tuần không thực hiện
for (let day = 1; day <= 30; day++) {
    if (day % 7 == 0) {
